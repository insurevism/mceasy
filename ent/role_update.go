...
func (ru *RoleUpdate) SetModifiedAt(t time.Time) *RoleUpdate {
	ru.mutation.SetModifiedAt(t)
	return ru
}
...
func (ru *RoleUpdate) defaults() {
	if _, ok := ru.mutation.ModifiedAt(); !ok {
		v := role.UpdateDefaultModifiedAt()
		ru.mutation.SetModifiedAt(v)
	}
}
...
func (ru *RoleUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := ru.mutation.ModifiedAt(); ok {
		_spec.SetField(role.FieldModifiedAt, field.TypeTime, value)
	}
...
// SetModifiedAt sets the "modified_at" field.
func (ruo *RoleUpdateOne) SetModifiedAt(t time.Time) *RoleUpdateOne {
	ruo.mutation.SetModifiedAt(t)
	return ruo
}
...
func (ruo *RoleUpdateOne) defaults() {
	if _, ok := ruo.mutation.ModifiedAt(); !ok {
		v := role.UpdateDefaultModifiedAt()
		ruo.mutation.SetModifiedAt(v)
	}
}
...
func (ruo *RoleUpdateOne) sqlSave(ctx context.Context) (_node *Role, err error) {
	...
	if value, ok := ruo.mutation.ModifiedAt(); ok {
		_spec.SetField(role.FieldModifiedAt, field.TypeTime, value)
	}
