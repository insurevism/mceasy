...
func (rc *RoleCreate) SetModifiedAt(t time.Time) *RoleCreate {
	rc.mutation.SetModifiedAt(t)
	return rc
}

// SetNillableModifiedAt sets the "modified_at" field if the given value is not nil.
func (rc *RoleCreate) SetNillableModifiedAt(t *time.Time) *RoleCreate {
	if t != nil {
		rc.SetModifiedAt(*t)
	}
	return rc
...
func (rc *RoleCreate) defaults() {
	...
	if _, ok := rc.mutation.ModifiedAt(); !ok {
		v := role.DefaultModifiedAt()
		rc.mutation.SetModifiedAt(v)
	}
}
...
func (rc *RoleCreate) check() error {
	...
	if _, ok := rc.mutation.ModifiedAt(); !ok {
		return &ValidationError{Name: "modified_at", err: errors.New(`ent: missing required field "Role.modified_at"`)}
	}
...
func (rc *RoleCreate) createSpec() (*Role, *sqlgraph.CreateSpec) {
	...
	if value, ok := rc.mutation.ModifiedAt(); ok {
