...
func (ruc *RoleUserCreate) SetModifiedAt(t time.Time) *RoleUserCreate {
	ruc.mutation.SetModifiedAt(t)
	return ruc
}

// SetNillableModifiedAt sets the "modified_at" field if the given value is not nil.
func (ruc *RoleUserCreate) SetNillableModifiedAt(t *time.Time) *RoleUserCreate {
	if t != nil {
		ruc.SetModifiedAt(*t)
	}
	return ruc
...
func (ruc *RoleUserCreate) check() error {
	...
	if _, ok := ruc.mutation.ModifiedAt(); !ok {
		return &ValidationError{Name: "modified_at", err: errors.New(`ent: missing required field "RoleUser.modified_at"`)}
	}
	return nil
}
...
func (ruc *RoleUserCreate) createSpec() (*RoleUser, *sqlgraph.CreateSpec) {
	...
	if value, ok := ruc.mutation.ModifiedAt(); ok {
		_spec.SetField(roleuser.FieldModifiedAt, field.TypeTime, value)
