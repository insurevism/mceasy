...
func (ruu *RoleUserUpdate) SetModifiedAt(t time.Time) *RoleUserUpdate {
...
func (ruu *RoleUserUpdate) defaults() {
	if _, ok := ruu.mutation.ModifiedAt(); !ok {
		v := roleuser.UpdateDefaultModifiedAt()
...
// SetModifiedAt sets the "modified_at" field.
func (ruuo *RoleUserUpdateOne) SetModifiedAt(t time.Time) *RoleUserUpdateOne {
